...
export default function Brand() {
    ...
    return (
        <section ref={containerRef} className="relative w-full bg-transparent py-24 overflow-hidden border-t border-white/[0.03]">
            ...
            <div className="container mx-auto px-6 md:px-12 max-w-7xl relative z-10 mb-16 text-center">
                <div className="brand-header inline-flex items-center gap-4 opacity-0">
                    ...
                    <h2 className="text-primary font-bold tracking-[0.3em] text-xs md:text-sm uppercase drop-shadow-[0_0_15px_rgba(212,175,55,0.5)]">
                    ...
                    {marqueeItems.map((brand, i) => (
                        <div key={`${brand.name}-${i}`} className="flex items-center gap-8 md:gap-12">
                            ...
                            <div className="flex items-center justify-center">
                                <svg className="w-4 h-4 md:w-5 md:h-5 text-primary/40 drop-shadow-[0_0_8px_rgba(212,175,55,0.5)]" viewBox="0 0 24 24" fill="currentColor">
